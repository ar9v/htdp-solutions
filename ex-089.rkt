...
;;; Design the `happy-cat` world program, which manages a walking cat and its happiness
;;; level. Let's assume the cat starts out with perfect happiness.
;;;
;;; HINT:
;;; 1. Reuse the functions from the world programs in chapter 3.7.
;;; 2. Use the structure type from the preceding exercise to represent the state of
;;;    the world
