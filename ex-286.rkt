...
;;; An inventory record specifies the name of an inventory item, a description, the
;;; acquisition price, and the recommended sales price.
;;;
;;; Define a function that sorts a list of inventory records by the difference between the
;;; the two prices.
...
(define (sort-by-price irs cmp)
  (sort irs (λ (ir1 ir2) (cmp (ir-price ir1) (ir-price ir2)))))
