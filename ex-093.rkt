...
;;; Copy your solution to exercise 92 and modify the copy so that the chameleon walks
;;; across a tricolor background. Our solution uses these colors:
...
;;; but you may use any colors. Observe how the chameleon changes colors to blend in as it
;;; crosses the border between two colors.

(define CHAM (bitmap/file "images/cham-transparent.png"))
...
; Graphical Constants
(define BACKGROUND
  (beside (empty-scene (/ WORLD-WIDTH 3) WORLD-HEIGHT "green")
          (empty-scene (/ WORLD-WIDTH 3) WORLD-HEIGHT "white")
          (empty-scene (/ WORLD-WIDTH 3) WORLD-HEIGHT "red")))
